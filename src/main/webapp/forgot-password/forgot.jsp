...
<div class="login-container">
    <div class="login-content col">
        <div class="login-content__logo"><a href="${root}/Splash.jsp"><img src="<%=request.getContextPath()%>/WEB-INF/jsp/img/logo.svg"
                                                                           alt=""> </a></div>
    ...
    <div class="login-form col">
        ...
        %>
        <form action="${root}/forgot-password/send" method="post" class="login-form__content needs-validation" novalidate>
            ...
            <div class="form-check form-element text-center">
                <span class="form-check-label pl-0">Or back to <a href="<%=request.getContextPath()%>/Splash.jsp">Log in page</a></span>
            </div>
        </form>
    </div>
</div>
