    ...
    <div class="row">
        ...
        <main role="main" class="main-container">
            ...
            <div class="content">
                ...
                <form action="${root}/employee/myaccount/addnewcard/add" method="post" id="billing-form-action" class="billing-form needs-validation" novalidate>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="create-payment-block">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h3 class="billing-form__subtitle mb-4">Add bank card</h3>
                                        ...
                                        <div class="form-group payment-create-dropdowns form-element mb-4">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <select
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group form-element mb-4" style="margin-top: 2.6rem !important">
                                            <div class="row">
