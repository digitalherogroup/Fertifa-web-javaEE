...
<div class="wrapper">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <div class="card card-primary custom-card">
                        ...
                        <form class="form-horizontal" action="${pageContext.request.contextPath}/admin/category/add/create" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="category_for" value="2">
                                            <label class="form-check-label">Employer</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="category_for" checked="" value="3">
    ...
    <!-- /.control-sidebar -->
<%--    <p> second results <%=request.getSession().getAttribute("notices")%>--%>
</div>
<!-- ./wrapper -->
<script>
