                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="partners-list" class="table table-bordered table-hover">
                                    <thead>
                                    <tr>
                                        <th>Partner</th>
                                        <th>Description</th>
                                    ...
                                    <tbody>
                                    <c:if test="${requestScope.PartnersFullList!=null}">
                                        <c:forEach items="${requestScope.PartnersFullList}" var="partner">
                                            <tr>
                                                <td>${partner.partnerName}</td>
                                                <td>${partner.partnerDiscription} </td>
                                                <td>${partner.domain} </td>
                                                <td class="table-buttons-manage">
                                                    <a href="${pageContext.request.contextPath}/admin/partners/edit?id=${partner.id}"
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog">
            <div class="modal-content bg-danger">
                <form action="${pageContext.request.contextPath}/admin/partners/delete" method="post">
                    ...
                    <div class="modal-body">
                        <p>Would you like to delete partner?</p>
