            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="card card-primary custom-card">
                        ...
                        <!-- form start -->
                        <form:form
                                class="form-horizontal create-product-form"
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" accept=".png,.jpg,.jpeg" name="file" id="file">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" maxlength="150" class="form-control" name="title" id="title" placeholder="Product Title" required="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="shortDescription" class="col-sm-2 col-form-label">Short Description</label>
                                    <div class="col-sm-10">
                                        <textarea maxlength="150" class="form-control" name="shortDescription"
                                                  id="shortDescription" placeholder="Short Description" required=""></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="description" class="col-sm-2 col-form-label">Description</label>
                                    <div class="col-sm-10">
                                        <textarea maxlength="1200" class="form-control" name="description" id="description" placeholder="Description" required=""></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
...
<%--                                </div>--%>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="published" id="published" checked="" value="0">
                                            <label for="published" class="form-check-label">Publish</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="published" id="unpublished" value="1">
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary custom-btn float-right create-product">Create</button>
                            </div>
                            <!-- /.card-footer -->
                        </form:form>
                    </div>
...
<script>
    $('.create-product-form').on('submit', function() {
