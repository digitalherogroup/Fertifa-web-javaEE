...
<title>Fertifa | adminSide Panel</title>
...
<link rel="stylesheet"
      href="${pageContext.request.contextPath}/plugins/bootstrap-datepicker/bootstrap-datepicker.standalone.min.css">
<!-- bootstrap -->
<link rel="stylesheet"
...
<%--<script>//https://fertifanew.herokuapp.com--%>
<%--const socket = io.connect('https://fertifanew.herokuapp.com', { //http://localhost:4000 //https://fertifachat.herokuapp.com--%>
