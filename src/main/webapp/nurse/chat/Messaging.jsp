...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <jsp:include page="../../includes/LogoAndBrandNurse.jsp"/>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <c:if test="${requestScope.NurseObject != null}">
                            <c:set value="${requestScope.NurseObject.firstName}" var="FirstNameToCut" scope="request"/>
                            <c:set value="${requestScope.NurseObject.lastName}" var="LastNameToCut" scope="request"/>
                            <%
                ...
                <div class="info">
                    <c:if test="${requestScope.NurseObject != null}">
                            <a href="#" class="d-block">${requestScope.NurseObject.firstName} ${requestScope.NurseObject.lastName}</a>

                    </c:if>

                </div>
            </div>
            <jsp:include page="../../includes/SidebarNurse.jsp"/>
            <!-- /.sidebar-menu -->
        </div>
        <!-- /.sidebar -->
    </aside>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/nurse/chat">Dashboard</a></li>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="card card-primary card-outline card-tabs">
                                ...
                                <%--<c:if test="${requestScope.ChatSessionListString != null}">
                                    <c:forEach items="${requestScope.ChatSessionListString}" var="ChatData">

                                        <c:set value='<%=request.getParameter("sessionid")%>' var="fromLink"
                                               scope="request"/>
                                        <c:set value='${ChatData.chatSessionToken}' var="fromData" scope="request"/>
                                        <%!
                                        ...
                                        %>
                                        <%
                                            SessionLink = String.valueOf(request.getAttribute("fromLink"));
                                            SessionData = String.valueOf(request.getAttribute("fromData"));
                                            activeSession = "";
                                        %>
                                        <%
                                            if (SessionLink.equals(SessionData)) {
                                                activeSession = "<li class=\"item  pr-2 active\">";
                                            } else {
                                                activeSession = "<li class=\"item  pr-2 \">";
                                            }
                                        %>
                                    </c:forEach>
                                </c:if>--%>
                                        ...
                                        <div class="tab-pane custom-tab-content-tab fade <%=typeChat%>"
                                            ...
                                            <ul class="sessions-list products-list product-list-in-card ">
                                                <c:if test="${requestScope.SessionChatlistRequest != null}">
                                                    <c:forEach items="${requestScope.SessionChatlistRequest}" var="ChatAdminDirectString">
                                                        <c:set value="${ChatAdminDirectString.chatCreationDate}" var="CreationDate" scope="request"/>
                                                        <c:set value="${ChatAdminDirectString.important_for_admin}" var="Important" scope="request"/>
                                                        <c:set value="${ChatAdminDirectString.chatSessionStatus}" var="StatusAdmin1"/>
                                                        ...
                                                        <a href="<%=request.getContextPath()%>/nurse/chat?id=${ChatAdminDirectString.chatFromId}&sessionid=${ChatAdminDirectString.chatSessionToken}"
                                                           class="block-href get-session-item"
                                                           data-session="jdhgfjf876">
                                                            <div class="product-img ">
                                                                <c:choose>
                                                                    <c:when test="${Important != 0}">
                                                                        <input class="star select-star-important" data-sessionId="${ChatAdminDirectString.chatSessionToken}" type="checkbox"
                                                            ...
                                                            <div class="product-info">
                                                                ...
                                                                <c:choose>
                                                                    ...
                                                                    ${ChatAdminDirectString.chatSessionToken}
                                            ...
                                            <ul class="sessions-list products-list product-list-in-card">
                                                <c:if test="${requestScope.SessionChatlistNotification != null}">
                                                    <c:forEach items="${requestScope.SessionChatlistNotification}"
                                                        ...
                                                        <c:set value="${ChatAdminRequest.chatCreationDate}" var="CreationDate" scope="request"/>
                                                        <c:set value="${ChatAdminRequest.important_for_admin}" var="Important" scope="request"/>
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/nurse/chat?id=${ChatAdminRequest.chatFromId}&sessionid=${ChatAdminRequest.chatSessionToken}"
                                                           class="block-href get-session-item"
                                                           data-session="jdhgfjf876">
                                                            <div class="product-img">
                                                                <c:choose>
                                                                    <c:when test="${Important != 0}">
                                                                        <input class="star select-star-important" data-sessionId="${ChatAdminRequest.chatSessionToken}" type="checkbox"
                                                                               title="bookmark page" checked>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <input class="star select-star-important" data-sessionId="${ChatAdminRequest.chatSessionToken}" type="checkbox"
                                            ...
                                            <ul class="sessions-list products-list product-list-in-card">
                                                <c:if test="${requestScope.SessionChatlistString != null}">
                                                    <c:forEach items="${requestScope.SessionChatlistString}"
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/nurse/chat?id=${directChatNotofy.chatFromId}&sessionid=${directChatNotofy.chatSessionToken}"
                                                           class="block-href get-session-item"
                                                           data-session="jdhgfjf876">
                                                            ...
                                                            <div class="product-img ">
                                                                <c:choose>
                                                                    <c:when test="${Important != 0}">
                                                                        <input class="star select-star-important" data-sessionId="${directChatNotofy.chatSessionToken}" type="checkbox"
                                                                               title="bookmark page" checked>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <input class="star select-star-important" data-sessionId="${directChatNotofy.chatSessionToken}" type="checkbox"
                                            ...
                                            <div class="card-header">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${type == 0 || type == 3}">
                                                            ...
                                                            <c:if test="${requestScope.SessionChatlistRequest != null}">
                                                                <c:forEach items="${requestScope.SessionChatlistRequest}"
                                                                    ...
                                                                    <c:if test="${requestScope.Token != ChatName.session_token}">
                                                                        <c:set value="${ChatName.companyName}"
                                                                               var="companyName"/>
                                                                        <c:choose>
                                                                            <c:when test="${companyName== null}">
                                                                                <h3 class="card-title">${ChatName.firstname} ${ChatName.lastname}</h3>
                                                                            </c:when>
                                                                            <c:otherwise>
                                                                                <h3 class="card-title">&lt;%&ndash;Direct Chat
                                                                            with&ndash;%&gt; ${ChatName.companyName}</h3>
                                                                            </c:otherwise>
                                                                        </c:choose>
                                                                    </c:if>
                                                                </c:forEach>
                                                        ...
                                                        <c:when test="${type == 2}">
                                                            <c:if test="${requestScope.SessionChatlistNotification != null}">
                                                                <c:forEach
                                                                        items="${requestScope.SessionChatlistNotification}"
                                                                        var="ChatName2">

                                                                    <c:if test="${requestScope.Token != ChatName2.session_token}">
                                                                        <c:set value="${ChatName2.companyName}"
                                                                               var="companyName"/>
                                                                        <c:choose>
                                                                            <c:when test="${companyName== null}">
                                                                                <h3 class="card-title">${ChatName2.firstname} ${ChatName2.lastname}</h3>
                                                                            </c:when>
                                                                            <c:otherwise>
                                                                                <h3 class="card-title">&lt;%&ndash;Direct Chat
                                                                            with&ndash;%&gt; ${ChatName2.companyName}</h3>
                                                                            </c:otherwise>
                                                                        </c:choose>
                                                                    </c:if>
                                                                </c:forEach>
                                                        ...
                                                        <c:when test="${type == 3}">
                                                            <c:if test="${requestScope.SessionChatlistString != null}">
                                                                <c:forEach items="${requestScope.SessionChatlistString}"
                                                                    ...
                                                                    <c:if test="${requestScope.Token != ChatName3.session_token}">
                                                                        <c:set value="${ChatName3.companyName}"
                                                                               var="companyName"/>
                                                                        <c:choose>
                                                                            <c:when test="${companyName == null}">
                                                                                <h3 class="card-title">&lt;%&ndash;Direct Chat
                                                                            with &ndash;%&gt;${ChatName3.firstname} ${ChatName3.lastname}</h3>
                                                                            </c:when>
                                                                            <c:otherwise>
                                                                                <h3 class="card-title">&lt;%&ndash;Direct Chat
                                                                            with&ndash;%&gt; ${ChatName3.companyName}</h3>
                                                                            </c:otherwise>
                                                                        </c:choose>
                                                                    </c:if>
                                                                </c:forEach>
...
<script defer src="<%=request.getContextPath()%>/WEB-INF/jsp/js/sessions.js"></script>
