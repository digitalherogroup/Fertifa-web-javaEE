...
@WebServlet("/AddnewStripeCustomer")
public class AddnewStripeCustomer extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            adnewStripeCustomer(request, response);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void adnewStripeCustomer(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    private void gotoAddCardPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("AddCustomerDetails.jsp").forward(request, response);
    }
