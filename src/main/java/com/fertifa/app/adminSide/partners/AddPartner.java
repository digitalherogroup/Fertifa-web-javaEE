...
@WebServlet("/admin/partners/add")
public class AddPartner extends com.fertifa.app.baseUrl.BaseUrl {
   ...
   public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void addPartner(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    private void gotoPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String url = request.getServletPath()+"/AddPartner.jsp";
