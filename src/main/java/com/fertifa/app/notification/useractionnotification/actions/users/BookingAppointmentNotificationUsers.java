...
public class BookingAppointmentNotificationUsers implements NotificationManagerUser {

    @Override
    public void sendUserMessage(Users users, int i) throws IOException, ServletException {
        String message = new UsersMessagesManager().getRightMessage(MessagesEnum.bookingAppointment,users,i);
        String subject = new UsersSubjectManager().getRightMessage(MessagesEnum.bookingAppointment, i);
