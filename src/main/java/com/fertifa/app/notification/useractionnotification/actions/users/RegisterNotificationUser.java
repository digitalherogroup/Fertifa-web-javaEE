...
public class RegisterNotificationUser implements NotificationManagerUser {


    @Override
    public void sendUserMessage(Users users, int i) throws IOException, ServletException {
        String message = new UsersMessagesManager().getRightMessage(MessagesEnum.register,users,i);
        String subject = new UsersSubjectManager().getRightMessage(MessagesEnum.register, i);
